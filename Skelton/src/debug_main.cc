...
int main(int argc, char* argv[])
{
  ...
  fpga_module.WriteModule(CIRASAME::MIG::kAddrNumWrite, 32);
  fpga_module.WriteModule(CIRASAME::MIG::kAddrNumRead,  16);

  std::cout << fpga_module.ReadModule(CIRASAME::MIG::kAddrNumWrite)
	    << ", "
	    << fpga_module.ReadModule(CIRASAME::MIG::kAddrNumRead)
	    << std::endl;
